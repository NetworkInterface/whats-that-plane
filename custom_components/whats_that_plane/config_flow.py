...
class WhatsThatPlaneConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        data_schema = vol.Schema({
            ...
            vol.Optional("use_planespotters_photos", default=False): bool,
...
class WhatsThatPlaneOptionsFlow(config_entries.OptionsFlow):
    async def async_step_init(self, user_input=None):
        ...
        options_schema = vol.Schema({
            ...
            vol.Optional("use_planespotters_photos", default=current_config.get("use_planespotters_photos", False)): bool,
